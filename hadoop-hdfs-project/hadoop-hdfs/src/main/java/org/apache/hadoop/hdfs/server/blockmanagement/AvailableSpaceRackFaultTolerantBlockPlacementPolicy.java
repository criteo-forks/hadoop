...
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_DEFAULT;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_KEY;
...
public class AvailableSpaceRackFaultTolerantBlockPlacementPolicy
  ...
  private int datanodesInComparison = DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_DEFAULT;
  ...
  public void initialize(Configuration conf, FSClusterStats stats,
    ...
    datanodesInComparison = conf.getInt(
            DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_KEY,
            DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_DEFAULT);
    if (datanodesInComparison < 2) {
      LOG.warn("The value of "
          + DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_KEY
          + " is less than 2 but should be at least 2. Default value "
          + DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_DEFAULT
          + " will be used.");
      datanodesInComparison = DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_DATANODES_IN_COMPARISON_DEFAULT;
    }
  ...
  protected DatanodeDescriptor chooseDataNode(final String scope,
    ...
    return select(() -> (DatanodeDescriptor) dfsClusterMap.chooseRandomWithStorageTypeTwoTrial(scope, excludedNode, type));
  }
  ...
  private DatanodeDescriptor select(Supplier<DatanodeDescriptor> datanodeSupplier) {
